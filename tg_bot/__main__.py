...
* I am using python-telegram-bot library in python3. I am totally open source. You can see my code in Thai. *
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="⭕️ Command Help ⭕️", url="https://t.me/{}?start=help".format(bot.username))],
                     [InlineKeyboardButton(text="📢Updates", url="t.me/mo_tech_yt") , InlineKeyboardButton(text="🤠Credits", url="https://github.com/REX-BOTZ")],
